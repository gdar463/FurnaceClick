...
public class FurnaceClick implements ModInitializer {
	...
	public void onInitialize() {
		AttackBlockCallback.EVENT.register(((player, world, hand, pos, direction) -> {
			...
			if (Arrays.asList(FurnaceClick.allowedBlocks).contains(Registries.BLOCK.getId(world.getBlockState(pos).getBlock())) && direction == world.getBlockState(pos).get(Properties.HORIZONTAL_FACING)) {
